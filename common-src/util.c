 ...
 * the array (only once).
 *
 * Of course, the day Unicode will be accounted for and needs to be used, this
 * part will have to be rewritten entirely...
 */
    ...
    gboolean always)
{
    ...
    return (always) ? do_quote_string(str) : stralloc(str);
}
