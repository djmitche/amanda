 ...
 */
/* 
 * $Id: sendsize.c,v 1.97.2.13.4.6.2.9 2002/03/31 19:13:59 jrjackson Exp $
 *
...
void add_diskest P((char *disk, char *amdevice, int level, int spindle, char *prog, option_t *options));
