 ...
 */
/*
 * $Id: scsi-hpux_new.c,v 1.1.2.12.4.1.2.3 2003/01/26 19:20:57 martinea Exp $
 *
...
{
#ifndef lint
    static char rcsid[] = "$Id: scsi-hpux_new.c,v 1.1.2.12.4.1.2.3 2003/01/26 19:20:57 martinea Exp $";
