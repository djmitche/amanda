 ...
 */
/*
 * $Id: scsi-linux.c,v 1.30.2.2 2007/02/22 18:28:34 martinea Exp $
 *
...
{
#ifndef lint
   static char rcsid[] = "$Id: scsi-linux.c,v 1.30.2.2 2007/02/22 18:28:34 martinea Exp $";
