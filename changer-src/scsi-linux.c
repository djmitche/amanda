 ...
 */
/*
 * $Id: scsi-linux.c,v 1.1.2.18.4.1.2.3 2003/01/26 19:20:57 martinea Exp $
 *
...
{
#ifndef lint
   static char rcsid[] = "$Id: scsi-linux.c,v 1.1.2.18.4.1.2.3 2003/01/26 19:20:57 martinea Exp $";
